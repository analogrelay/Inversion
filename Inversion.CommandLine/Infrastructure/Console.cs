...
namespace Inversion.CommandLine.Infrastructure
{
    ...
    public class Console : IConsole
    {
        ...
        public void WriteWarning(bool prependWarningText, string value, params object[] args)
        {
            ...
            {
                message = String.Format(CultureInfo.CurrentCulture, InversionResources.CommandLine_Warning, value);
            }
            else
            {
                message = value;
        ...
        public bool Confirm(string description)
        {
            ...
            try
            {
                ...
                System.Console.Write(String.Format(CultureInfo.CurrentCulture, InversionResources.ConsoleConfirmMessage, description));
                var result = System.Console.ReadLine();
                return result.StartsWith(InversionResources.ConsoleConfirmMessageAccept, StringComparison.OrdinalIgnoreCase);
            }
            finally
            {
                System.Console.ForegroundColor = currentColor;
