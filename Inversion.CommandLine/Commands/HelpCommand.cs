...
namespace Inversion.CommandLine.Commands
{
    ...
    [Command(typeof(InversionResources), "help", "HelpCommandDescription", AltName = "?", MaxArgs = 1,
    ...
    public class HelpCommand : Command
    {
        ...
        [Option(typeof(InversionResources), "HelpCommandAll")]
        public bool All { get; set; }

        [ImportingConstructor]
        public HelpCommand(ICommandManager commandManager)
            : this(commandManager, Assembly.GetExecutingAssembly().GetName().Name, "inVersion")
        {
        }
        ...
        public HelpCommand(ICommandManager commandManager, string commandExe, string productName)
        {
