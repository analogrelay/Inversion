    ...
    public class CommandLineParser
    {
        ...
        public ICommand ExtractOptions(ICommand command, IEnumerator<string> argsEnumerator)
        {
            ...
            while (true)
            {
                ...
                if (!results.Any())
                {
                    throw new CommandLineException(InversionResources.UnknownOptionError, option);
                }
                ...
                if (results.Skip(1).Any())
                {
                    ...
                    {
                        throw new CommandLineException(String.Format(CultureInfo.CurrentCulture, InversionResources.AmbiguousOption, optionText,
                ...
                if (value == null)
                {
                    throw new CommandLineException(InversionResources.MissingOptionValueError, option);
                }
        ...
        private static void AssignValue(PropertyInfo property, ICommand command, string option, object value)
        {
            ...
            {
                throw new CommandLineException(InversionResources.InvalidOptionValueError, option, value);
            }
        }
        ...
        public ICommand ParseCommandLine(IEnumerable<string> commandLineArgs)
        {
            ...
            if (cmd == null)
            {
                throw new CommandLineException(InversionResources.UnknownCommandError, cmdName);
            }
